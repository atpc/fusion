...
open class XGraphics internal constructor(private val g2d: Graphics2D) : Graphics2D() {
    ...
    override fun getBackground(): Color = g2d.background
    ...
    override fun getColor(): Color = g2d.color
    ...
    override fun drawImage(img: Image?, x: Px, y: Px, bgcolor: Color?, observer: ImageObserver?): Boolean
